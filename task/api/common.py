...
# .env 파일 로드
load_dotenv(dotenv_path=r"C:\Users\qhfma\Downloads\On-premises-LLM-Web-Front-kyeonghwan\.env")

# 데이터셋 로드
DATA_PATH = r'C:\Users\qhfma\Downloads\On-premises-LLM-Web-Front-kyeonghwan\dataSet4.json'
